...
$(STATEDIR)/cross-gdb.prepare:
	...
	cd $(CROSS_GDB_DIR)/gdb/gdbserver && \
		 $(CROSS_GDB_PATH) $(CROSS_GDB_ENV) \
		./configure --host=$(PTXCONF_GNU_TARGET) --prefix=$(SYSROOT)/usr
	@$(call touch)
...
$(STATEDIR)/cross-gdb.compile:
	...
	cd $(CROSS_GDB_DIR)/gdb/gdbserver && $(CROSS_GDB_PATH) $(MAKE) $(PARALLELMFLAGS) LDFLAGS=-static
	@$(call touch)
...
$(STATEDIR)/cross-gdb.install:
	...
	cd $(CROSS_GDB_DIR)/gdb/gdbserver && $(MAKE) install
	@$(call touch)
